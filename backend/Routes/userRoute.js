...
const { registerUser, authUser, getUser, logoutUser, addToFavorite, removeFromFavorite,getFavs, getMyProducts, editMyProduct } = require("../Controllers/userControllers");
...
router.route("/admin/:product_id/edit").put(checkProductExist, editMyProduct);
