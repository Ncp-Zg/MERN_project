...
const { registerUser, authUser, getUser, logoutUser, addToFavorite, removeFromFavorite,getFavs, getMyProducts } = require("../Controllers/userControllers");
...
router.route("/profile/getmyproducts").get(protect, getMyProducts);
